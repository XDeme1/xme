...
struct DestroyA {
    ...
    constexpr void operator()(Iter first, Sent last, Alloc& alloc) noexcept {
...
struct DestroyAtA {
    ...
    constexpr void operator()(T* pos, Alloc& alloc) noexcept {
        using traits = std::allocator_traits<Alloc>;
...
struct DestroyNA {
    ...
    constexpr void operator()(Iter first, std::iter_difference_t<Iter> n, Alloc& alloc) noexcept {
