...
template<typename T>
concept totally_ordered_c = CEqualityComparable<T> && detail::partially_ordered_with_c<T, T>;

template<typename T, typename U>
concept totally_ordered_with_c =
  totally_ordered_c<T> && totally_ordered_c<U> && CEqualityComparableWith<T, U>
  && totally_ordered_c<
